...
\begin{table}[H]
\centering
\caption{Matriz comparativa de alcances y límites del proyecto}\label{tab:alcance_limites}
\begin{tabular}{|>{\raggedright\arraybackslash}p{6.8cm}|>{\raggedright\arraybackslash}p{7.2cm}|}
\hline
