...
Desarrollar e implementar un sistema mecatrónico periférico de monitoreo no invasivo basado en Internet de las Cosas (IoT) y algoritmos de Inteligencia Artificial en el borde (\textit{Edge AI}), orientado a evaluar continuamente el estado de desgaste de las herramientas de corte en tornos CNC de la empresa MAINSA. Para este propósito central, se efectuará la fusión sensorial de variables de corriente y vibración mecánica, buscando anticipar oportunamente fallas críticas de insertos, optimizar los acabados superficiales y reducir los tiempos improductivos por retrabajo en planta.

\subsubsection*{Objetivos específicos}
\phantomsection\addcontentsline{toc}{subsubsection}{Objetivos específicos}

Para alcanzar de manera exitosa y estructurada el objetivo general formulado en la presente investigación, se han delimitado los siguientes cinco objetivos específicos secuenciales:

\begin{itemize}
\item Recopilar y analizar la información técnica, operativa y normativa sobre los procesos de mecanizado por torneado CNC y los mecanismos tribológicos de desgaste de herramientas en el taller de la empresa MAINSA.
\item Diseñar la arquitectura mecatrónica integral del sistema periférico de monitoreo, estructurando la etapa de acondicionamiento analógico a valores eficaces, el procesamiento digital en el borde (\textit{Edge AI}) y la conectividad IoT.
\item Seleccionar y dimensionar los transductores de corriente no invasivos, los sensores de acelerometría y la unidad de procesamiento embebido, en función de las exigencias dinámicas y rangos operativos del torno CNC.
\item Implementar e integrar el prototipo mecatrónico periférico, programando el firmware de adquisición, los algoritmos de filtrado digital, el clasificador ligero de desgaste y la plataforma de supervisión remota.
\item Validar experimentalmente el funcionamiento y exactitud diagnóstica del sistema integrado bajo condiciones reales de corte en torno CNC en MAINSA, evaluando la mejora en la rugosidad superficial y la reducción de mermas.
\end{itemize}
...
1. Recopilar y analizar información técnica, operativa y normativa sobre mecanizado y desgaste de herramientas en MAINSA. & 
\textbullet\ Revisión técnica de manuales operativos, cinemática y parámetros de corte de los tornos CNC en planta.\\
...
2. Diseñar la arquitectura mecatrónica del sistema periférico no invasivo, acondicionamiento, Edge AI e IoT. & 
\textbullet\ Definición del esquema funcional por bloques (adquisición, acondicionamiento, procesamiento y enlace IoT).\\
& \textbullet\ Diseño del circuito de acondicionamiento para rectificación y conversión a niveles continuos proporcionales a RMS.\\
& \textbullet\ Diseño esquemático y ruteo de la placa de circuito impreso (PCB) con aislamiento galvánico industrial.\\
& \textbullet\ Concepción del gabinete y soportes de fijación no invasiva para la instalación periférica en la máquina.\\ \hline

3. Seleccionar y dimensionar los sensores de corriente, acelerómetros y componentes del sistema embebido. & 
\textbullet\ Dimensionamiento del rango y relación de transformación del transductor de corriente según la potencia del motor.\\
...
& \textbullet\ Selección de la unidad de procesamiento embebido evaluando periféricos ADC, DMA, instrucciones DSP y memoria.\\
& \textbullet\ Cálculo y selección de componentes pasivos de filtrado analógico, resistencias de carga y fuentes de poder.\\ \hline

4. Implementar e integrar el prototipo mecatrónico, firmware, modelo de clasificación y supervisión IoT. & 
\textbullet\ Fabricación, ensamble y verificación eléctrica de la tarjeta de adquisición y módulos de acondicionamiento.\\
& \textbullet\ Programación del firmware para muestreo síncrono, filtrado digital y extracción de parámetros estadísticos temporales.\\
...
5. Validar experimentalmente el funcionamiento y exactitud diagnóstica del sistema integrado en MAINSA. & 
...
& \textbullet\ Ejecución de ensayos de torneado cilíndrico registrando señales con insertos nuevos, desgastados y al fin de vida.\\
& \textbullet\ Medición metrológica de la rugosidad superficial ($Ra$) en probetas y verificación de tolerancias dimensionales.\\
& \textbullet\ Evaluación cuantitativa de la exactitud de clasificación y cuantificación de la reducción de mermas operativas.\\ \hline
