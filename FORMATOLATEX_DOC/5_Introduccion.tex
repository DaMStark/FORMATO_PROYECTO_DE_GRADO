...
Con el propósito de operativizar cada uno de los objetivos específicos formulados y garantizar una ejecución técnica viable y rigurosa sin sobreestimar el alcance del proyecto, en la \tab{acciones_objetivos} se detallan las acciones concretas asociadas a cada fase de desarrollo.
...
1. Diseñar la arquitectura de hardware del nodo de adquisición (STM32, SCT013 y acelerómetro). & 
\textbullet\ Selección y dimensionamiento técnico de los sensores y el microcontrolador.\\
& \textbullet\ Diseño del circuito de acondicionamiento analógico para conversión a nivel DC/RMS compatible con el ADC.\\
& \textbullet\ Diseño y fabricación de la placa PCB con aislamiento galvánico para entorno industrial.\\
& \textbullet\ Ensamble e integración mecánica no invasiva de los módulos en el torno CNC.\\ \hline

2. Programar el firmware dedicado para muestreo y procesamiento digital de señales. & 
\textbullet\ Configuración de temporizadores y ADC con acceso directo a memoria (DMA) en el STM32.\\
& \textbullet\ Implementación de rutinas de filtrado digital pasa-bajos para atenuación de ruido electromagnético.\\
& \textbullet\ Programación de algoritmos para el cálculo del valor eficaz (RMS) y parámetros temporales de vibración.\\
& \textbullet\ Validación experimental de la sincronía de muestreo y precisión de la adquisición.\\ \hline

3. Desarrollar y entrenar el modelo ligero de \textit{Edge AI} para clasificación de desgaste. & 
\textbullet\ Adquisición y etiquetado de registros de mecanizado bajo estados de filo nuevo, desgaste y rotura.\\
& \textbullet\ Entrenamiento y ajuste de hiperparámetros de un clasificador supervisado compacto.\\
& \textbullet\ Cuantización y optimización del modelo a punto fijo mediante herramientas embebidas.\\
& \textbullet\ Medición de la exactitud de clasificación y evaluación del tiempo de inferencia local en el microcontrolador.\\ \hline

4. Implementar la interfaz de monitoreo remoto IoT y generación de alertas. & 
\textbullet\ Configuración del protocolo de comunicación inalámbrico para la transmisión de estados operativos.\\
& \textbullet\ Desarrollo de una interfaz gráfica de usuario para la visualización remota de parámetros en tiempo real.\\
& \textbullet\ Programación de umbrales jerárquicos para notificación preventiva de desgaste crítico.\\
& \textbullet\ Evaluación de la robustez de la comunicación y latencia del enlace en el taller.\\ \hline

5. Validar experimentalmente el prototipo en las instalaciones de MAINSA. & 
\textbullet\ Instalación del sistema en el torno CNC bajo operaciones reales de cilindrado y desbaste.\\
& \textbullet\ Medición de la rugosidad superficial ($Ra$) en probetas mecanizadas con herramientas monitoreadas.\\
& \textbullet\ Registro y comparación de tiempos de parada e incidentes por rotura frente al método tradicional.\\
& \textbullet\ Análisis estadístico de los resultados obtenidos y redacción del informe técnico final.\\ \hline
