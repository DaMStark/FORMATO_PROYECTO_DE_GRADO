...
\item Se considerará como escenario de aplicación industrial las operaciones de torneado longitudinal y refrentado en piezas cilíndricas de aceros al carbono y de media aleación (AISI 1045 y AISI 4140) comúnmente procesados en la planta.
...
\item Se comprobará la funcionalidad básica del sistema mediante pruebas de laboratorio en banco de pruebas y validación en taller, verificando adquisición de señales, estabilidad del acondicionamiento, exactitud en la inferencia del modelo embebido y confiabilidad en la transmisión de datos.
...
\begin{itemize}
\item El proyecto se limitará a la detección y clasificación del desgaste en herramientas de torneado con insertos intercambiables de carburo recubierto, por lo que no contemplará geometrías de herramientas para fresado, taladrado ni materiales cerámicos o superabrasivos (CBN/PCD).
...
\item El diseño y dimensionamiento del sistema se realizarán con criterios de operación industrial real; sin embargo, la construcción física y validación experimental se limitarán a un prototipo funcional periférico implementado en una máquina herramienta específica de MAINSA.
\item La instalación física del sistema no implicará la intervención directa de los controladores numéricos de la máquina, los servoamplificadores internos ni los circuitos de paro de emergencia (\textit{E-Stop}), garantizando la preservación de las garantías de los equipos.
