...
\begin{figure}[H]
    \centering
    \caption{Árbol de problemas del proceso de torneado CNC en MAINSA}
    \includegraphics[width=0.80\textwidth]{arbol_de_problemas}
    \par
...
Torneado en aceros de alta exigencia (AISI 1045, 4140 y 4340). & Procesos de fresado o taladrado; y mecanizado en materiales blandos (nylon, bronce) o aleaciones exóticas. \\ \hline
...
\item Si bien la instrumentación física posee la capacidad de adquirir señales ante cualquier proceso de corte, el proyecto delimita explícitamente las pruebas y la validación del modelo a materiales de alta exigencia mecánica, excluyendo materiales blandos como polímeros técnicos (nylon, teflón, poliacetal) y aleaciones no ferrosas de baja dureza (bronce, latón o aluminio blando). Esta delimitación responde a que dichos materiales blandos demandan un esfuerzo de corte reducido y provocan un desgaste insignificante en el filo, generando variaciones de corriente y vibración prácticamente imperceptibles que no reproducen las condiciones operativas severas ni los patrones de falla reales que acontecen en el taller de MAINSA.
