...
Asimismo, un factor operacional crítico observado en planta es la falta de visualización en tiempo real del proceso de generación y desprendimiento de viruta durante el ciclo de mecanizado en cabina cerrada. Cuando la arista de corte pierde agudeza, el inserto deja de cizallar limpiamente el material e inicia una fricción plástica severa que tiende a quemar o frotar la pieza, alterando la morfología y el volumen normal de viruta desprendida. Al no contar con visibilidad directa ni monitoreo continuo de este fenómeno, el operario es incapaz de advertir oportunamente la anomalía, desencadenando dos consecuencias perjudiciales: por un lado, la sobrecarga mecánica provoca el desportillamiento o la rotura violenta del filo que arruina la pieza; y por otro, genera pérdidas considerables de tiempo productivo debido a que el técnico debe detener la máquina para limpiar esquirlas adheridas y realizar complejas labores de retrabajo.
...
\begin{itemize}
\item Investigar los tipos de procesos de mecanizado en torno CNC, los mecanismos de desgaste de herramientas de corte y las tecnologías de inteligencia artificial en el borde (\textit{Edge AI}) orientadas al monitoreo de condición.
