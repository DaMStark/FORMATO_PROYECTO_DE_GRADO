...
% Tipo de titulación
\newcommand{\titulacion}{Proyecto de Grado}
...
\begin{document}
 ...
 % Espaciados de hoja
    ...
    \input{6_Marco_Teorico.tex}
    %\input{7_Marco_Metodologico.tex}
    %\input{8_Marco_Practico.tex}
    %\input{9_Conclusiones.tex}
    %\input{10_Recomendaciones.tex}
