...
Con la finalidad de estructurar rigurosamente las bases conceptuales que respaldan el cumplimiento de los objetivos específicos y las acciones técnicas del proyecto, en la \tab{contenido_tematico} se presenta la matriz esquemática del contenido temático desarrollado.

{\setlength{\parskip}{1.5pt}
\begin{longtable}{|L{3.8cm}|L{4.8cm}|L{4.4cm}|}
\caption{Matriz esquemática del contenido temático del fundamento teórico}
\label{tab:contenido_tematico}
\\
\hline
\textbf{Área temática} & \textbf{Temas fundamentales} & \textbf{Relevancia en el proyecto} \\
\hline \hline
\endfirsthead
...
\multicolumn{3}{c}{\textbf{Fuente:} Elaboración propia}
\endlastfoot

1. Mecánica de corte y procesos de torneado CNC & 
Operaciones de torneado, cinemática de corte ($V_c, f, a_p$), tasa de remoción de material ($MRR$), descomposición de fuerzas ($F_c, F_a, F_r$) y potencia de corte. & 
Modelado del régimen de operación del torno en MAINSA y cálculo del esfuerzo mecánico sobre el husillo.\\ \hline

2. Tribología y degradación de herramientas & 
Mecanismos de desgaste (abrasión, adhesión, difusión), norma ISO 3685, morfología del desgaste de flanco ($VB, Af$), curvas de Taylor y rugosidad teórica ($Ra$). & 
Definición de los umbrales de desgaste admisible y correlación con la pérdida de calidad superficial en piezas.\\ \hline

3. Monitoreo de condición de herramientas (TCM) & 
Métodos directos vs. indirectos de supervisión, monitoreo por corriente eléctrica, acelerometría en torreta y fusión sensorial multimodal. & 
Sustento de la instrumentación periférica no invasiva para operar sin perturbar el ciclo productivo.\\ \hline

4. Transductores y acondicionamiento analógico & 
Transformadores de corriente de núcleo partido (SCT013), acelerómetros piezoeléctricos/MEMS, circuitos rectificadores de precisión, filtrado pasivo y balance electromecánico. & 
Aislamiento galvánico, acondicionamiento de señales alternas a niveles proporcionales de tensión DC y captura de vibración.\\ \hline

5. Procesamiento digital de señales (DSP) & 
Criterio de Nyquist-Shannon, filtrado digital IIR/Butterworth, extracción de descriptores temporales ($I_{RMS}, a_{RMS}$, Curtosis, Factor de Cresta). & 
Acondicionamiento digital y reducción dimensional para la conformación del vector de características de entrada a la IA.\\ \hline

6. Inteligencia artificial en el borde (TinyML) & 
Paradigmas de inferencia local en microcontroladores, arquitecturas ARM Cortex-M4/M7, cuantización entera (INT8), algoritmos de clasificación (MLP, SVM, Random Forest). & 
Diagnóstico determinista y en tiempo real del estado de desgaste sin depender de conectividad a servidores externos.\\ \hline

7. Telemática industrial e IoT & 
Protocolo ligero MQTT, arquitectura Publicador/Suscriptor, Calidad de Servicio (QoS), serialización JSON y paneles de control operativos (dashboards). & 
Transmisión eficiente de telemetría y generación de alertas jerárquicas tempranas para los operarios y supervisores en planta.\\
\end{longtable}
}
...
\subsubsection{Arquitectura de conectividad IoT para mantenimiento predictivo}
