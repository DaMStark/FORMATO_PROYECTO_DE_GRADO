...
\begin{longtable}{|>{\raggedright\arraybackslash}p{3.3cm}|>{\raggedright\arraybackslash}p{5.7cm}|>{\raggedright\arraybackslash}p{4.7cm}|}
\caption{Matriz esquemática del contenido temático del fundamento teórico\label{tab:contenido_tematico}}
\\
\hline
...
Transmisión eficiente de telemetría y generación de alertas jerárquicas tempranas para los operarios y supervisores en planta.\\ \hline
\end{longtable}
}
